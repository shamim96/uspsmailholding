    ...
    <table style="width: 100%">
        <tr>
            <td>
                ...
                <p> Your request to hold your mail with order ID <span style="font-weight: bold">{{$body['id']}}</span> has been completed for the following dates: <span style="font-weight: bold">{{$body['startDate']}}</span> - <span style="font-weight: bold">{{$body['endDate']}} </span> . </p>
